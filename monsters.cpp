...
entity_info const MONSTER_INFO[] PROGMEM =
{
    ...
    */
    ...
    { 1, 0, 0, 1, 0, 0, 0, 0, 1,  6,  4,  4,  1,  12,  7 }, // phantom
    { 1, 0, 0, 0, 0, 0, 0, 0, 1,  7,  4,  4,  2,  16,  7 }, // orc
    { 1, 0, 0, 0, 0, 0, 0, 1, 0,  5,  4,  4,  0,  12,  7 }, // tarantula
    { 1, 0, 0, 0, 0, 0, 0, 0, 1,  8,  4,  4,  3,  20,  8 }, // hobgoblin
    { 1, 1, 0, 0, 0, 0, 0, 0, 0,  8,  4,  4,  3,  20,  8 }, // mimic
    { 1, 0, 0, 0, 0, 0, 1, 0, 1,  9,  4,  4,  3,  24, 10 }, // incubus
    { 1, 0, 1, 0, 0, 0, 0, 0, 1, 12,  3,  3,  5,  32, 11 }, // troll
    { 1, 0, 0, 0, 0, 0, 0, 0, 0,  7,  6,  6,  1,  24, 12 }, // griffin
    { 1, 0, 0, 0, 0, 0, 1, 1, 1, 10,  6,  6,  3,  24, 16 }, // fallen angel
    { 1, 0, 0, 0, 0, 0, 0, 0, 0, 20,  4,  4,  8,  48, 20 }, // dragon
    { 1, 0, 1, 0, 1, 1, 1, 1, 1, 24,  6,  8,  8,  64, 50 }, // lord of darkness
};
